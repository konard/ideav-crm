...
Компонент автоматически определяет тип поля и отображает соответствующий элемент управления:

- **Текстовые поля** (SHORT, CHARS) - обычный input
- **Многострочные поля** (MEMO) - textarea с поддержкой форматирования
